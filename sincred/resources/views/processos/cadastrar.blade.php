                        ...
                        <div class="panel-heading">
                            <ul class="nav nav-tabs" style="margin-bottom: -13px;">
                                <li class="active nav-link">
                                    ...
                                    <a href="{{url('processos/novo')}}" style="text-decoration: none; color: #212529;"> 
                ...
                <div class="card-body">
                    ...
                    <br>
                        ...
                        <div class="row">
                            ...
                            {!! Form::date('inicio', null, ['class' => 'form-control', 'autofocus', 'placeholder' => '00/00/0000']) !!}<small>Data de Início do Processo.</small>
                            </div>

                            <div class="col-sm-3 col-lg-3 col-md-3">
                            <strong> {!! Form::label('final', 'Data Final *') !!} </strong>
                            {!! Form::date('final', null, ['class' => 'form-control', 'autofocus', 'placeholder' => '00/00/0000']) !!}<small>Data de Final do Processo.</small>
