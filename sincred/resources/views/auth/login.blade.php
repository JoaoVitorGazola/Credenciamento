            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <label for="user" class="col-md-4 col-form-label text-md-right" placeholder="Usuário">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right" placeholder="Senha">
