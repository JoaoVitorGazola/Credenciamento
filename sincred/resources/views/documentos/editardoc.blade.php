    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="card">
                    <div class="card-header"> <h2>Editar Documento Requisitado </h2>
                        <br>
                    ...
                    <div class="card-body">
                        ...
                        <div class="float-right">
                            ...
                            <button class="btn btn-primary btn-md"><a href="{{url('/documentos/editar-palavras')}}" style="color: #fff; text-decoration: none;">Continuar</a>
                            </button>
